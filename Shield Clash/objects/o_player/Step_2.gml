...
if (not _onDodge)
{
	...
	if (Dust >= 5)
	{
		...
		// particula a usar
		part_type_shape(Step,pt_shape_cloud);
		// escala
		part_type_scale(Step,0.15,0.15);
		// duracion de la particula (STEPS)
		part_type_life(Step, 10,20);
		// efecto de disipación
		part_type_alpha3(Step, 0.1, 1, 0);
		// color
		...
		// rotación
		part_type_orientation(Step,0,359,0.1,0,true);
		// gravedad
		part_type_gravity(Step,0.1,90);
		// mezcla
